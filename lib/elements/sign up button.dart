    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: ()async
        {
          if(sign_up_controller.box1 == true){
            if(sign_up_controller.box2 == true){
              ...
              prefs.setString("password", "${sign_up_controller.password.text}");
              ...
              prefs.setString("Is Logged In", "true");
              print("Done");
              ...
              showTopSnackBar(
                ...
                CustomSnackBar.error(
                  message:
                  "Something went wrong. Intrest can't be empty",
                ),
              );
            }
          }else{
        ...
        child: Container(
          ...
          child: Center(child: show_spinner
          ? SpinKitSpinningLines(
            color: Colors.white,
            size: 50.0,
          )
          : Text("SIGN UP",
            style: GoogleFonts.poppins(color: Colors.white,fontSize: 20,letterSpacing: 3),),),
        ),
      ),
    );
  }
